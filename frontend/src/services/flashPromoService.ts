...
export const getFlashPromoById = async (id: string) => {
  try {
    const response = await axiosInstance.get(`/flash-promos/${id}`);
    return response.data;
  } catch (error) {
...
export const createFlashPromo = async (flashPromo: NewFlashPromo) => {
  try {
    const response = await axiosInstance.post('/flash-promos', flashPromo);
    return response.data;
  } catch (error) {
...
export const updateFlashPromoStatus = async (id: string, isActive: boolean) => {
  try {
    const response = await axiosInstance.patch(`/flash-promos/${id}/status`, { isActive });
    return response.data;
  } catch (error) {
...
export const joinFlashPromo = async (id: string, userId: string) => {
  try {
    const response = await axiosInstance.post(`/flash-promos/${id}/join`, { userId });
    return response.data;
  } catch (error) {
