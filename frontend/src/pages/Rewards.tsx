...
interface Reward {
  ...
  UsersClaimed: {
    // Add UsersClaimed to the Reward interface
...
const Rewards: React.FC = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      // Use absolute URL to Render backend
  ...
  useEffect(() => {
    if (user && user.rewardsclaimed) {
      ...
      if (allRewards.length > 0 && user.rewardsclaimed.length > 0) {
        const sampleCheck = user.rewardsclaimed.some(
          (claimed) => String(claimed.rewardsid) === String(allRewards[0]._id)
        );
        console.log(
          "Sample reward check result:",
          sampleCheck,
          "Comparing:",
          user.rewardsclaimed[0]?.rewardsid,
          "with",
          allRewards[0]?._id
        );
      }
  ...
  const fetchGames = async () => {
    try {
      // Use absolute URL to Render backend
      const response = await fetch(`https://forgeph-2.onrender.com/api/games`);
      if (!response.ok) {
  ...
  useEffect(() => {
    if (user && user.rewardsclaimed && allRewards.length > 0) {
      ...
      allRewards.forEach((reward) => {
        ...
        console.log(
          `Reward: ${reward.name} (${reward._id}) - Claimed: ${isClaimed}`
        );
      });
    }
  }, [user, allRewards]);
  ...
  const hasClaimedReward = (rewardId: string): boolean => {
    ...
    return user.rewardsclaimed.some((reward) => reward.rewardsid === rewardId);
  };
  ...
  const handleRedeemReward = async (
    ...
    try {
      ...
      const response = await fetch(
        "https://forgeph-2.onrender.com/api/auth/redeem-reward",
        {
          method: "POST",
          headers: {
  ...
  const faqItems = [
    {
      ...
      answer:
        "You can earn points by redeeming promo codes, making purchases, referring friends, and participating in XForge events and social media campaigns.",
    },
    {
      id: "faq-2",
      question: "When do my points expire?",
      answer:
        "XForge reward points are valid for 12 months from the date they were earned. Make sure to use them before they expire!",
    },
    {
      id: "faq-3",
      question: "How long does it take to receive my reward?",
      answer:
        "Digital rewards like discount codes are delivered instantly. Physical rewards typically ship within 5-7 business days.",
    },
    {
      id: "faq-4",
      question: "Can I transfer my points to someone else?",
      answer:
        "Currently, points cannot be transferred between accounts. Each account's points can only be redeemed by that account holder.",
    },
  ];
      ...
      <main className="flex-grow pb-16">
        ...
        <div className="relative pt-32 pb-16 overflow-hidden">
          <div className="absolute inset-0 z-0">
            ...
            <div className="absolute top-0 left-0 w-full h-full">
              ...
              <div
                className="absolute top-[30%] right-[15%] w-32 h-32 rounded-full bg-[#8B5CF6]/20 blur-3xl animate-float"
                style={{ animationDelay: "1s" }}
              ></div>
              <div
                className="absolute bottom-[20%] left-[20%] w-40 h-40 rounded-full bg-[#F97316]/20 blur-3xl animate-float"
          ...
          <div className="container mx-auto relative z-10 px-4">
            <div className="text-center mb-8">
              ...
              <p className="text-xforge-gray max-w-2xl mx-auto">
                ...
                and experiences. Your journey to amazing rewards starts here!
              </p>
            </div>
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    <div>
                      ...
                      <p className="text-xforge-gray max-w-md">
                        Redeem your points for exclusive rewards and enjoy
                    ...
                    <div className="relative">
                      ...
                      <div className="relative glass-teal rounded-full p-8 text-center border border-xforge-teal/30">
                        <div className="flex items-baseline justify-center">
                          <span className="text-5xl font-bold text-xforge-teal">
                            {currentPoints}
                          </span>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xforge-gray max-w-2xl mx-auto">
              Test your luck and skill with our collection of games. Win points
              and exclusive rewards daily!
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-xforge-gray max-w-2xl mx-auto">
              Redeem your hard-earned points for exclusive products, discounts,
              and special perks.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {faqItems.map((faq) => (
                <div
                  key={faq.id}
                  className="bg-gradient-to-br from-xforge-dark/80 to-[#141b22] rounded-xl overflow-hidden shadow-lg border border-white/5 backdrop-blur-sm"
                >
                  <button
