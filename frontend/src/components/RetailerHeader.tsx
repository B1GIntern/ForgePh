...
const Header: React.FC = () => {
  ...
  const isUserVerified = user && user.userStatus === "Verified";
          ...
          <nav className="hidden space-x-8 md:flex">
            {user ? (
              isUserVerified ? (
                ...
                // Unverified user - locked links
                <>
                  <a
                    href="#"
                    className="nav-link opacity-70 cursor-not-allowed"
                    onClick={(e) => {
                      e.preventDefault();
